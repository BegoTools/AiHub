...
import { Upload, File, X, Image, FileText, Music, Video, AlertCircle, Loader2 } from 'lucide-react'
import { processUploadedFile, formatFileSize, type FileInfo } from '../services/fileService'
